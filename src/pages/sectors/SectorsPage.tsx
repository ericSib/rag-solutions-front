...
import { CheckCircle, FileText, Users, Briefcase } from 'lucide-react';
...
const sectors = [
  ...
  },
  {
    ...
    benefits: [
      "Centralisation des baux, contrôts et documents réglementaires",
...
export default function SectorsPage() {
  return (
    <>
      <Helmet>
        <title>Nos Secteurs d'Activité | RAG Solutions</title>
        <meta
          name="description"
          content="Découvrez comment RAG Solutions s'adapte à votre secteur d'activité pour optimiser votre gestion documentaire et améliorer votre efficacité opérationnelle."
        />
      </Helmet>
