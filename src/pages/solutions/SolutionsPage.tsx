...
const SolutionsPage: React.FC = () => {
  ...
  return (
    <div className="w-full">
      <Helmet>
        <title>Nos Solutions | RAG Solutions</title>
        <meta
          name="description"
          content="Découvrez nos solutions de gestion documentaire basées sur la technologie RAG (Retrieval-Augmented Generation) : performances, éthique et innovation."
        />
      </Helmet>
