...
export default function StarterPackPage() {
  return (
    <>
      <Helmet>
        <title>Pack Starter - RAG Solutions</title>
        <meta
          name="description"
          content="Découvrez notre Pack Starter, la solution idéale pour les PME souhaitant optimiser leur gestion documentaire de manière simple et sécurisée."
        />
      </Helmet>
