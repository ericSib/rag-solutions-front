...
import { ChevronRight, CheckCircle, Zap, Lock, Users, Star } from 'lucide-react';

export default function EnterprisePackPage() {
  return (
    <>
      <Helmet>
        <title>Pack Enterprise - RAG Solutions</title>
        <meta
          name="description"
          content="Découvrez notre Pack Enterprise, la solution sur-mesure et évolutive pour les grands groupes souhaitant une transformation globale de leur gestion documentaire."
        />
      </Helmet>
