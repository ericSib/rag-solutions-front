...
export const metadata: Metadata = {
  title: 'Pack BUSINESS - RAG Solutions',
  description: 'Solution complète pour les entreprises en croissance. Optimisez votre gestion documentaire avec notre technologie RAG performante.',
  openGraph: {
    title: 'Pack BUSINESS - RAG Solutions',
    description: 'Solution complète pour les entreprises en croissance. Optimisez votre gestion documentaire avec notre technologie RAG performante.',
  },
    ...
    <>
      <div className="container mx-auto px-4 py-12">
        <h1 className="text-4xl md:text-5xl font-bold mb-6">
          Pack BUSINESS <br/>
          <span className="text-blue-600">La performance RAG pour votre entreprise</span>
        </h1>
