...
export const metadata: Metadata = {
  title: 'Pack STARTER - RAG Solutions',
  description: 'Découvrez notre pack STARTER, la solution idéale pour débuter avec RAG Solutions. Transformez votre gestion documentaire dès maintenant.',
  openGraph: {
    title: 'Pack STARTER - RAG Solutions',
    description: 'Découvrez notre pack STARTER, la solution idéale pour débuter avec RAG Solutions. Transformez votre gestion documentaire dès maintenant.',
  },
